# coding:utf-8
from agent.common.exceptions import dict_value_is_empty, str_length_valid, mixture_length_valid
...
class ConfigInit:
    ...
    def tags_common(self, _type):
        ...
        return 'branch=' + dict_value_is_empty(self.config_dict, 'branch') \
               ...
               + ',pid=' + self.__get_pid() \
               + ',project=' + mixture_length_valid(dict_value_is_empty(self.config_dict, 'project'), 10, 'project') \
